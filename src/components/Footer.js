  ...
  return (
    <div className="mt-4 bg-dark-200 rounded-md text-white px-8 py-4">
      <ul className="text-center">
        ...
        <li><a href="#experience" className="hover:underline">Work Experience</a></li>
        <li><a href="#projects" className="hover:underline">Personal Projects</a></li>
      ...
      <p className="text-sm font-light text-center">Copyright © 2023 Sebastian Thomas. All Right Reserved</p>
